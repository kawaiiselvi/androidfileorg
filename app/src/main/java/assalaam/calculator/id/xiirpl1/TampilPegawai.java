...
public class TampilPegawai extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextSalary = (EditText) findViewById(R.id.editTextNumber);
    ...
    private void showEmployee(String json){
        try {
            ...
            String sal = c.getString(Konfigurasi.TAG_NO);
            String add = c.getString(Konfigurasi.TAG_ALAMAT);
            String cit = c.getString(Konfigurasi.TAG_CITA);

            editTextName.setText(name);
            editTextDesg.setText(desg);
            editTextSalary.setText(sal);
            editTextAddress.setText(add);
            editTextAmbition.setText(cit);
    ...
    private void updateEmployee(){
        ...
        final String ambition = editTextAmbition.getText().toString().trim();
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(Konfigurasi.KEY_EMP_KELAS,desg);
                hashMap.put(Konfigurasi.KEY_EMP_NO,salary);
                hashMap.put(Konfigurasi.KEY_EMP_ALAMAT,address);
                hashMap.put(Konfigurasi.KEY_EMP_CITA,ambition);
